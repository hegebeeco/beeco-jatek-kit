...
const keretBeallitasok = (function(){
  ...
  let reduce = ls('beeco_reduce', '0') === '1';
  const alkalmaz = () => document.body && document.body.classList.toggle('reduce-motion', reduce);
  ...
  return { panelHTML, bekot, get kevesebbMozgas(){ return reduce || matchMedia('(prefers-reduced-motion: reduce)').matches; }, get erintes(){ return erintes(); } };
})();
